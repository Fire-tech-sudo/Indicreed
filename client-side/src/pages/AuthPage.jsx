        ...
        <div className="relative hidden lg:flex flex-col justify-between p-10 bg-primary border-r border-gray-200 overflow-hidden">
          ...
          <div className="relative z-10">
            <AnimatePresence mode="wait">
              ...
              >
                <h2 className="font-display-lg text-4xl text-black leading-tight mb-4">
                  {isLogin ? (
                    <>
                      Welcome
                      <br />
                ...
                <p className="text-white font-body-md leading-relaxed max-w-sm text-sm">
                  {isLogin
            ...
            <div className="grid grid-cols-3 gap-3 mt-8">
              {[
                ...
                <div key={i} className="text-center py-3 border border-white">
                  <div className="text-black font-display-lg text-lg">
                    {stat.value}
                  </div>
                  <div className="text-white font-label-caps text-[10px] tracking-wider mt-1">
                    {stat.label}
                  </div>
                </div>
              ))}
          ...
          <div className="relative z-10 bg-white border border-gray-200 p-4 mb-20">
            ...
            <p className="text-gray-500 text-sm leading-relaxed italic font-body-md">
        ...
        <div className="relative bg-black p-6 sm:p-10 lg:p-12 overflow-y-auto">
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="mb-6"
            >
              <h1 className="font-display-lg text-2xl sm:text-3xl text-white mb-1">
                {isLogin ? "Sign In" : "Create Account"}
              </h1>
              <p className="text-gray-400 text-sm font-body-md">
                {isLogin
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative flex items-center gap-4 my-5">
              ...
              <span className="text-gray-400 text-xs font-label-caps tracking-wider">
                OR CONTINUE WITH
              </span>
              <div className="flex-1 h-px bg-outline-variant/50" />
            </div>
