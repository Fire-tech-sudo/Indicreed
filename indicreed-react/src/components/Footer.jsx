    ...
    <footer className="border-t border-gray-800 py-8 px-4 sm:px-6 bg-[#0a0a0a]">
      <div className="container mx-auto text-center text-gray-600">
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 mb-6">
          <a
            href="https://www.instagram.com/indicreed/"
            target="_blank"
            rel="noreferrer"
          ...
          <Link
            ...
            title="Portfolio"
          >
            <span className="text-blue-500 text-base font-extrabold leading-none cinzel-font">
              A
            </span>
          </Link>
        </div>
        ...
        <p>
          © {new Date().getFullYear()} INDICREED STUDIOS. All Rights Reserved.
          Crafted by Aryan Sharma.
        </p>
