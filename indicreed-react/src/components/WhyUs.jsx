...
export default function WhyUs() {
  return (
    <section id="why-us" className="py-16 sm:py-24 px-4 sm:px-6 relative section-glow">
      <div className="container mx-auto text-center max-w-6xl">
        <ScrollReveal direction="up">
          <h2 className="text-sm font-bold text-blue-500 uppercase tracking-widest mb-2">
            Our Competitive Edge
          </h2>
          <h3 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white">The Indicreed Difference</h3>
        </ScrollReveal>

        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map(({ icon: Icon, title, description }, index) => (
            <ScrollReveal key={title} direction="up" delay={index * 0.1}>
              <div className="glass-card p-6 sm:p-8 rounded-3xl text-center h-full">
