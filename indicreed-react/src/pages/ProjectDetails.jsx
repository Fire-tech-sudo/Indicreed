...
const ProjectDetail = () => {
  ...
  const getCategoryGradient = (category) => {
    const gradients = {
      ...
      "Social Media": "from-purple-500 to-blue-600",
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center gap-5">
        ...
        <div className="relative w-16 h-16">
          ...
          />
          <FaFilm className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-blue-400 text-lg" />
        </div>
  ...
  if (!project) {
    return (
      <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center text-center px-5">
        <FaFilm className="text-6xl text-blue-500/30 mb-6" />
        <h1 className="text-8xl font-extrabold bg-gradient-to-r from-blue-500 to-blue-600 bg-clip-text text-transparent mb-3">
          404
        </h1>
        ...
        <Link
          to="/portfolio"
          className="flex items-center gap-3 px-8 py-4 bg-blue-600 
                     text-white rounded-xl font-semibold transition-all hover:scale-105 
                     hover:shadow-xl hover:shadow-blue-500/30 cta-button"
        >
      ...
      <div className="max-w-7xl mx-auto px-7 pb-20">
        ...
        <div className="pt-24 pb-8">
          <button
            ...
            className="inline-flex items-center gap-3 px-6 py-3 
                       text-blue-400 border border-gray-700 rounded-full 
                       font-semibold text-sm transition-all duration-300 
                       hover:bg-blue-500/20 hover:-translate-x-1 cursor-pointer"
          >
            <FaArrowLeft /> Back to Portfolio
          </button>
        </div>
        ...
        <section className="mb-16">
          <div className="relative flex items-center gap-4">
            ...
            <button
              onClick={prevImage}
              className="w-12 h-12 bg-blue-500/20 border-2 border-blue-500/30 
                         text-blue-400 rounded-full flex items-center justify-center 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="glass-card rounded-2xl p-8">
              <h2 className="flex items-center gap-3 text-2xl font-bold text-white mb-6">
                <FaFilm className="text-blue-400" /> Project Overview
              </h2>
            ...
            <div className="glass-card rounded-2xl p-8">
              ...
              <div className="flex flex-wrap gap-3">
                {project.technologies.map((tech, index) => (
                  <span
                    key={index}
                    className="px-5 py-2.5 bg-blue-500/10 text-blue-400 rounded-xl 
                               text-sm font-semibold border border-blue-500/20 
          ...
          <div className="lg:col-span-1">
            <div className="glass-card rounded-2xl p-8 sticky top-28">
              ...
              >
                <FaVideo className="text-blue-400" /> Project Details
              </h3>
              ...
              <div className="space-y-6">
                {infoItems.map((item, index) => (
                  <div key={index} className="flex items-center gap-4 group">
                    <div
                      className="w-12 h-12 bg-blue-500/10 rounded-xl flex items-center 
                                    justify-center text-blue-400 flex-shrink-0 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            {prevProject ? (
              <Link
                ...
                className="group glass-card rounded-2xl p-6 
                           transition-all duration-300 hover:border-blue-500/40 hover:-translate-y-2"
              >
                <span className="flex items-center gap-2 text-blue-400 text-sm font-semibold mb-2">
            ...
            {nextProject ? (
              <Link
                ...
                className="group glass-card rounded-2xl p-6 
                           text-right transition-all duration-300 hover:border-blue-500/40 hover:-translate-y-2"
              >
                <span className="flex items-center justify-end gap-2 text-blue-400 text-sm font-semibold mb-2">
                  Next Project
